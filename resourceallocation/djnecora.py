...
class DJNecora(JNecora):
    ...
    def initialize_hosts(self):
        ...
        self._available_resources_per_host = {
            host_label: {"cpu_share": 1 if not host.infinite_parallelism else float("inf"), "ram": host.ram_gb}
    ...
    def add_process(self, process_name: str):
            ...
            for host_label, host in self.context.hosts.items():
                ...
                best_fitting_cpu_share_record = max(
                    (
                        ...
                        if p == process_name and h == host_label
        ...
        debug(f"--- **Process {process_name} added** ---")
...
if __name__ == "__main__":
    ...
    djnecora.add_process("P2")
    djnecora.add_process("P3")
    djnecora.add_process("P4")
    djnecora.add_process("P5")
    djnecora.add_process("P6")
    djnecora.add_process("P7")
